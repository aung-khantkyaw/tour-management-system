<x-layouts.guest :title="$destination->destination_name . ' Packages - Tour Management System'">
    <div class="max-w-7xl mx-auto px-4 py-16">
        <!-- Navigation -->
        <div class="mb-6">
            <a href="{{ route('destinations') }}" class="inline-flex items-center text-sm text-blue-600 hover:text-blue-800 transition-colors">
        ...
        <div class="relative h-96 rounded-2xl overflow-hidden mb-10 shadow-2xl">
            @if($destination->destination_profile)
                <img src="{{ asset('storage/' . $destination->destination_profile) }}" alt="{{ $destination->destination_name }}" class="w-full h-full object-cover">
            @else
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600">Choose from {{ $destination->tourist_packages_count }} carefully curated tour packages</p>
        </div>
