                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    <div class="space-y-2">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h1 class="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Destinations Management</h1>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                <p class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Total Destinations</p>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                ...
                                <p class="text-3xl font-bold text-gray-900 mt-1">{{ $destinations->sum('hotels_count') }}</p>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                <p class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Total Packages</p>
                                <p class="text-3xl font-bold text-gray-900 mt-1">{{ $destinations->sum('tourist_packages_count') }}</p>
                            </div>
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse($destinations as $destination)
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-lg overflow-hidden hover:shadow-2xl hover:border-blue-200 transition-all duration-300 transform hover:-translate-y-2 group"
                        ...
                        <div class="relative h-48 bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100 overflow-hidden">
                            ...
                            <div class="absolute top-4 right-4">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-emerald-100 text-emerald-800 shadow-sm">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex items-center text-gray-600">
                                    ...
                                    <span class="text-sm font-medium">{{ $destination->city ?? 'City not specified' }}</span>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-6">
                                ...
                                <div class="text-center p-3 bg-purple-50 rounded-xl border border-purple-100">
                                    <p class="text-2xl font-bold text-purple-600">{{ $destination->tourist_packages_count }}</p>
                ...
                @empty
                    <div class="col-span-full">
                        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 text-center">
                            ...
                            <p class="text-gray-600 mb-8 max-w-md mx-auto">Get started by creating your first destination. Add beautiful locations for travelers to explore.</p>
                            <a href="{{ route('admin.destinations.create') }}"
