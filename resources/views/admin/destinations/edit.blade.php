        ...
        <div class="p-6 lg:p-8 space-y-8"
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Edit Destination</h1>
                            <p class="text-gray-600 font-medium">Update destination information</p>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="px-8 py-6 bg-gradient-to-r from-amber-50 to-orange-50 border-b border-gray-100">
                    <h2 class="text-xl font-bold text-gray-900">Update Destination Information</h2>
                    <p class="text-gray-600 text-sm mt-1">Modify the details below to update the destination</p>
                </div>
                
                <form action="{{ route('admin.destinations.update', $destination) }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        <div class="space-y-2">
                            ...
                            <input name="destination_name" type="text" 
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="description" rows="4" 
                            ...
                            placeholder="Describe this destination, its attractions, and what makes it special..." required>{{ old('description', $destination->description) }}</textarea>
                    ...
                    <div class="space-y-4">
                        ...
                        @if($destination->destination_profile && $destination->destination_profile !== 'default-profile.jpg')
                            <div class="mb-6">
                                ...
                                <div class="relative inline-block">
                                    <img src="{{ Storage::url($destination->destination_profile) }}"
                                        class="w-full max-w-md h-64 object-cover rounded-xl border-2 border-gray-200 shadow-lg" alt="Current destination image">
                            ...
                            <label for="image-upload" class="cursor-pointer">
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">PNG, JPG, GIF up to 10MB (optional)</p>
                                    </div>
                        ...
                        <template x-if="preview">
                            <div class="mt-6">
                                <p class="text-sm font-semibold text-gray-700 mb-3">New Image Preview:</p>
                                <div class="relative inline-block">
