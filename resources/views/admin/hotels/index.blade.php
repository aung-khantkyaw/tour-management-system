                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    <div class="space-y-2">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h1 class="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Hotels Management</h1>
                                <p class="text-gray-600 font-medium">Manage and oversee all hotels</p>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
                        <div class="relative flex-1 min-w-[280px]">
                            <input type="search" x-model.debounce.200ms="searchQuery"
                                ...
                                class="w-full rounded-xl border-2 border-gray-200 pl-12 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-200 bg-gray-50 hover:bg-white"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <div class="p-4 rounded-2xl bg-gradient-to-r from-teal-500 to-teal-600 shadow-lg">
                            ...
                            <div class="ml-5">
                                ...
                                <p class="text-3xl font-bold text-gray-900 mt-1">{{ $hotels->total() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                <p class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Avg Rating</p>
                                <p class="text-3xl font-bold text-gray-900 mt-1">{{ number_format($hotels->avg('rating'), 1) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                <p class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Accommodations</p>
                                <p class="text-3xl font-bold text-gray-900 mt-1">{{ $hotels->sum('accommodations_count') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse($hotels as $hotel)
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-lg overflow-hidden hover:shadow-2xl hover:border-teal-200 transition-all duration-300 transform hover:-translate-y-2 group"
                        x-show="!searchQuery || [$el.dataset.name, $el.dataset.destination].some(v => v && v.toLowerCase().includes(searchQuery.toLowerCase()))"
                        x-cloak data-name="{{ $hotel->name }}" data-destination="{{ $hotel->destination->destination_name ?? '' }}">
                        
                        <!-- Hotel Header -->
                        <div class="relative h-48 bg-gradient-to-br from-teal-100 via-cyan-100 to-blue-100 overflow-hidden">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent"></div>
                            <div class="flex items-center justify-center h-full text-teal-500">
                                <div class="text-center">
                                    ...
                                    <p class="text-sm font-medium opacity-60">Hotel</p>
                                </div>
                            </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center text-gray-600">
                                        ...
                                        <span class="text-sm font-medium">{{ $hotel->destination->destination_name ?? 'No destination' }}</span>
                                    </div>
                                    <div class="flex items-center text-gray-600">
                                        <svg class="w-4 h-4 mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                                        </svg>
                                        <span class="text-sm font-medium">{{ $hotel->contact_no }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-6">
                                <div class="text-center p-3 bg-teal-50 rounded-xl border border-teal-100">
                                    <p class="text-2xl font-bold text-teal-600">{{ $hotel->accommodations_count }}</p>
                                    <p class="text-xs font-semibold text-teal-500 uppercase tracking-wide">Accommodations</p>
                                </div>
                                <div class="text-center p-3 bg-yellow-50 rounded-xl border border-yellow-100">
                                    <div class="flex justify-center items-center mb-1">
                                        @for($i = 1; $i <= 5; $i++)
                                            <svg class="w-4 h-4 {{ $i <= $hotel->rating ? 'text-yellow-400' : 'text-gray-300' }}" fill="currentColor" viewBox="0 0 20 20">
                                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                            </svg>
                                        @endfor
                                    </div>
                                    <p class="text-xs font-semibold text-yellow-500 uppercase tracking-wide">Rating</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <a href="{{ route('admin.hotels.delete', $hotel) }}"
                ...
                @empty
                    <div class="col-span-full">
                        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 text-center">
                            ...
                            <p class="text-gray-600 mb-8 max-w-md mx-auto">Get started by adding your first hotel. Create comfortable accommodations for travelers.</p>
                            <a href="{{ route('admin.hotels.create') }}"
