        ...
        <div class="p-6 lg:p-8 space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Edit Hotel</h1>
                            <p class="text-gray-600 font-medium">Update hotel information</p>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="px-8 py-6 bg-gradient-to-r from-amber-50 to-orange-50 border-b border-gray-100">
                    <h2 class="text-xl font-bold text-gray-900">Update Hotel Information</h2>
                    <p class="text-gray-600 text-sm mt-1">Modify the details below to update the hotel</p>
                </div>
                
                <form action="{{ route('admin.hotels.update', $hotel) }}" method="POST" class="p-8 space-y-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        <div class="space-y-2">
                            ...
                            <input name="name" type="text" value="{{ old('name', $hotel->name) }}"
                        ...
                        <div class="space-y-2">
                            ...
                            <input name="contact_no" type="text" value="{{ old('contact_no', $hotel->contact_no) }}"
                                class="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-200 bg-gray-50 hover:bg-white" 
                            ...
                            <select name="destination_id" 
                                ...
                                @foreach($destinations as $destination)
                                    <option value="{{ $destination->destination_id }}" 
                                        {{ old('destination_id', $hotel->destination_id) == $destination->destination_id ? 'selected' : '' }}>
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                            <div class="bg-white rounded-lg p-3">
                                ...
                                <p class="font-semibold text-gray-900">{{ $hotel->destination->destination_name ?? 'Not assigned' }}</p>
                            </div>
                            <div class="bg-white rounded-lg p-3">
                            ...
                            <div class="bg-white rounded-lg p-3">
                                <p class="text-gray-600">Accommodations</p>
                                <p class="font-semibold text-gray-900">{{ $hotel->accommodations_count ?? 0 }} rooms</p>
                            </div>
                        </div>
                    </div>
