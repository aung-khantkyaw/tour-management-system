            ...
            <div class="bg-red-50 border-l-4 border-red-400 text-red-700 px-6 py-4 rounded-r-lg shadow-sm">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-sm">Deleting this booking will permanently remove it from the system. Customer
                            data and payment information will be lost.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                        <div class="space-y-6">
                            <div>
                                <h3 class="text-2xl font-bold text-gray-900 mb-2">Booking #{{ $booking->booking_id }}
                                </h3>
                                <div class="space-y-2">
                                    <div class="flex items-center text-gray-600">
                                        ...
                                        <span
                                            class="font-medium">{{ $booking->user->name ?? 'Unknown Customer' }}</span>
                                    </div>
                                    <div class="flex items-center text-gray-600">
                                        <svg class="w-4 h-4 mr-2 text-gray-400" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                            ...
                            <div class="bg-blue-50 rounded-xl p-4 border border-blue-100">
                                ...
                                <div class="space-y-2">
                                    <p class="text-sm"><span class="font-medium">Package:</span>
                                        {{ $booking->schedule->touristPackage->package_name ?? 'N/A' }}</p>
                                    <p class="text-sm"><span class="font-medium">Destination:</span>
                                        {{ $booking->schedule->touristPackage->destination->destination_name ?? 'N/A' }}
                                    </p>
                                    <p class="text-sm"><span class="font-medium">Guide:</span>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-green-50 rounded-xl p-4 border border-green-100">
                                ...
                                <div class="space-y-2">
                                    <p class="text-sm"><span class="font-medium">Booking Date:</span>
                                        {{ \Carbon\Carbon::parse($booking->booking_date)->format('M d, Y') }}</p>
                                    <p class="text-sm"><span class="font-medium">Tour From:</span>
                                        {{ \Carbon\Carbon::parse($booking->schedule->from_date)->format('M d, Y') }}</p>
                                    <p class="text-sm"><span class="font-medium">Tour To:</span>
            ...
            ($booking->package_status === 'completed' ? 'bg-purple-100 text-purple-800' : 'bg-gray-100 text-gray-800'))) }}">
                            ...
                            <div class="bg-amber-50 rounded-xl p-4 border border-amber-100">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="text-2xl font-bold text-amber-800">${{ number_format($booking->total_amount) }}</span>
                                </div>
                                @if($booking->payment_transaction_id)
                                    <p class="text-xs text-amber-600 mt-2">Transaction ID:
                                        {{ $booking->payment_transaction_id }}</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-amber-50 border border-amber-200 rounded-xl p-6 mb-8">
                        <div class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 mt-0.5" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
