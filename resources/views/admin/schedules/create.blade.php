        ...
        <div class="p-6 lg:p-8 space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Add New Schedule</h1>
                            <p class="text-gray-600 font-medium">Create a schedule for tour packages</p>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="px-8 py-6 bg-gradient-to-r from-green-50 to-emerald-50 border-b border-gray-100">
                    ...
                    <p class="text-gray-600 text-sm mt-1">Fill in the details below to create a new schedule</p>
                </div>
                
                <form action="{{ route('admin.schedules.store') }}" method="POST" class="p-8 space-y-8">
                    @csrf
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <input name="from_date" type="date" value="{{ old('from_date') }}" min="{{ date('Y-m-d') }}"
                            ...
                            <div class="space-y-2">
                                ...
                                <input name="to_date" type="date" value="{{ old('to_date') }}"
                                    class="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 bg-white" required>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                        <button type="submit" 
                            class="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 font-semibold">
